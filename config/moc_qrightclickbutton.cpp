...
#include "../include/qrightclickbutton.h"
...
constexpr auto qt_meta_stringdata_CLASSQRightClickButtonENDCLASS = QtMocHelpers::stringData(
    "QRightClickButton",
    "rightClicked",
    "",
    "leftClicked"
...
void QRightClickButton::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->leftClicked((*reinterpret_cast< std::add_pointer_t<int>>(_a[1]))); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            using _t = void (QRightClickButton::*)(int );
            if (_t _q_method = &QRightClickButton::rightClicked; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void QRightClickButton::rightClicked(int _t1)
{
...
// SIGNAL 1
void QRightClickButton::leftClicked(int _t1)
{
    void *_a[] = { nullptr, const_cast<void*>(reinterpret_cast<const void*>(std::addressof(_t1))) };
