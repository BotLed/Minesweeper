...
constexpr auto qt_meta_stringdata_CLASSPopupENDCLASS = QtMocHelpers::stringData(
    "Popup",
    "exitGame",
    "",
    "resetGame"
...
void Popup::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            using _t = void (Popup::*)();
            if (_t _q_method = &Popup::exitGame; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (Popup::*)();
            if (_t _q_method = &Popup::resetGame; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 1;
                return;
            }
        }
